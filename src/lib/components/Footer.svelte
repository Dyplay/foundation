...
<footer class="footer">
  <div class="container">
      ...
      <div class="footer-links-section">
        <div class="footer-links-group">
          ...
          <div class="footer-links">
            <a href="#" class="footer-link">{companyName} Chat</a>
            <a href="#" class="footer-link">Tunneled</a>
            <a href="#" class="footer-link">Benchmark</a>
            <a href="#" class="footer-link">{companyName}OS</a>
          </div>
        </div>
    ...
    <div class="footer-bottom">
      <div>© {companyName} {currentYear}. All rights reserved.</div>
      <div>
        <span>Release: Q4 2023</span>
      </div>
    </div>
  </div>
</footer>
